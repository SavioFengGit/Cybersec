/* File JavaScript per la ricerca di transazioni su blockchain inserendo l'hash dell'immagine */
...
// Inseriamo l'address del contratto utilizzando un processo sincrono di immissione di input da tastiera
var image_hash = readlineSync.question('PLEASE, ENTER IMAGE HASH: ');
...
// Chiamiamo la funzione getIDByImageHash() contenuta nello smart contract passando l'hash dell'immagine che verrà inserito in input dall'utente; questa funzione restituirà l'ID della transazione relativa all'hash inserito.
contract.methods.getIDByImageHash(image_hash).call((err, result) => {if (result==0){
